...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <!-- video -->
    <script type='text/javascript' src="../../Public/site/tivi/jwplayer.js"></script>
    <script type='text/javascript'>
        jQuery('document').ready(function () {
            jwplayer('mediaspace').setup({
                'flashplayer': '../../Public/site/tivi/player.swf',
    ...
    <!-- zoom image -->
    <script src="../../Public/site/jqzoom_ev/js/jquery.jqzoom-core.js" type="text/javascript"></script>
    <link rel="stylesheet" href="../../Public/site/jqzoom_ev/css/jquery.jqzoom.css" type="text/css">
    <script type="text/javascript">
        $(document).ready(function () {
            $('.jqzoom').jqzoom({
                zoomType: 'standard',
    ...
    <div class="box-center">
        ...
        <div class="box-content-center product">
            ...
            <div class='product_view_img'>
                <a href="../../Public/upload/product/product13.jpg" class="jqzoom" rel='gal1' title="triumph">
                    <img src="../../Public/upload/product/product13.jpg" alt='Tivi LG 520' style="width: 280px !important">
                </a>
                <div class='clear' style='height: 10px'></div>
                <div class="clearfix">
                    <ul id="thumblist">
                        <li>
                            <a class="zoomThumbActive" href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: '../../Public/upload/product/product13.jpg',largeimage: '../../Public/upload/product/product13.jpg'}">
                                <img src='../../Public/upload/product/product13.jpg'>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class='product_view_content'>
                ...
                <p class='option'>
                    Giá: <span class='product_price'>5,400,000 đ</span>
                </p>
            ...
            <table width="100%" cellspacing="0" cellpadding="3" border="0" class="tbsicons">
                <tbody>
                    <tr>
                        <td width="25%">
                            <img alt="Phục vụ chu đáo" src="../../Public/site/images/icon-services.png">
                            <div>Phục vụ chu đáo</div>
                        </td>
                        <td width="25%">
                            <img alt="Giao hàng đúng hẹn" src="../../Public/site/images/icon-shipping.png"><div>Giao hàng đúng hẹn</div>
                        </td>
                        <td width="25%">
                            <img alt="Đổi hàng trong 24h" src="../../Public/site/images/icon-delivery.png">
    ...
    <div class="box-center">
        ...
        <div class="box-content-center product">
            ...
            <div class='product_item'>
                <h3>
                    <a href="" title="Sản phẩm">Tivi LG 5000
                    </a>
                </h3>
                <div class='product_img'>
                    <a href="http://localhost/webphp/san-pham-Tivi-LG-5000/6.html" title="Sản phẩm">
                        <img src="../../Public/upload/product/product5.jpg" alt='' />
                    </a>
                </div>
                <p class='price'>
                    5,000,000 đ
